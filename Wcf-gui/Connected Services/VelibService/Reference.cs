...
namespace Wcf_gui.VelibService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="VelibService.IVelibService", CallbackContract=typeof(Wcf_gui.VelibService.IVelibServiceCallback))]
    public interface IVelibService {
        ...
        Wcf_gui.VelibService.Station[] GetStations(string city);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/GetStations", ReplyAction="http://tempuri.org/IVelibService/GetStationsResponse")]
        System.Threading.Tasks.Task<Wcf_gui.VelibService.Station[]> GetStationsAsync(string city);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IVelibServiceChannel : Wcf_gui.VelibService.IVelibService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class VelibServiceClient : System.ServiceModel.DuplexClientBase<Wcf_gui.VelibService.IVelibService>, Wcf_gui.VelibService.IVelibService {
        ...
        public Wcf_gui.VelibService.Station[] GetStations(string city) {
            return base.Channel.GetStations(city);
        }
        
        public System.Threading.Tasks.Task<Wcf_gui.VelibService.Station[]> GetStationsAsync(string city) {
